...
% Enter transformation matrices from Appendix 8.1.2
...
%pretty(gramian)
det_gramian = simplify(det(gramian))
%print(det_gramian)
...
m_num = subs(det_gramian, [a2, a3, a4, d5], [a2_val, a3_val, a4_val, d5_val]);
